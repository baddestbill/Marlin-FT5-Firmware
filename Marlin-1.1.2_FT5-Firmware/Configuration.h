...
#define STRING_CONFIG_H_AUTHOR "(Long Le, Folgertech FT5 R2 Titan Extruder and e3d-v6)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.72, 79.72, 396.63, 428.44 }  //changed E0 from 105 to 428.44 for titan extruder with pancake motor
